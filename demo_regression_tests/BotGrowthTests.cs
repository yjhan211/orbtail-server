...
public sealed class BotGrowthTests
{
    ...
    public void BotSummonUsesHumanCostAndCounter()
    {
        ...
        var decisions = new BotBehaviorService(growth, new PlayerOrbTrailService(), new PlayerInteractionService(), NullLogger<BotBehaviorService>.Instance, new game_server.matches.MatchMovementService());
