...
public sealed class SunOrbAttackServiceTests
{
    ...
    public void Process_WaitsForTelegraphHitsOnceAndRemovesExpiredDodgeSnapshot()
    {
        ...
        var service = new SunOrbAttackService(store, TestGameSessionServices.CreateEliminationService(store, logs, new game_server.matches.results.MatchSummaryFileStore(), Microsoft.Extensions.Logging.Abstractions.NullLogger.Instance), logs);
