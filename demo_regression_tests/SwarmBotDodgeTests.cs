...
public class SwarmBotDodgeTests
{
    ...
    private static GameServer.SwarmCrossfireDodgeThreat LineAlongX(long ownerId = 7, double armedInSeconds = 0.55) =>
        new(217001, AreaType.Ground, ownerId, 0f, 0f, 1f, 0f,
    ...
    public void BotOnTheLine_StepsPerpendicularToTheAxis()
    {
        ...
        var direction = GameServer.ResolveSwarmBotDodgeDirection(
    ...
    public void BotOutsideTheBand_DoesNotReact()
    {
        ...
        var direction = GameServer.ResolveSwarmBotDodgeDirection(
            threats, 217001, -900000001, new Vector3f(2f, 0.6f, 0f), AreaType.Ground, Now);
    ...
    public void ProjectileAlreadyPassed_DoesNotReact()
    {
        ...
        var direction = GameServer.ResolveSwarmBotDodgeDirection(
            threats, 217001, -900000001, new Vector3f(2f, 0f, 0f), AreaType.Ground, Now);
    ...
    public void DiagonalLine_ReturnsWorldSpacePerpendicular()
    {
        ...
        var threat = new GameServer.SwarmCrossfireDodgeThreat(
            217001, AreaType.Ground, 7, 0f, 0f, s, s, 6f, 0.35f, 4.5f, Now.AddSeconds(0.55), Now.AddSeconds(2.05));
