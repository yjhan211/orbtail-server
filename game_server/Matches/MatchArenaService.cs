    ...
    ILogger<MatchArenaService> logger)
{
    ...
    // 상태 홀더(matchRuntimes.GetOrThrow(matchingId).Progress 등, Matches/States)로 이동했다.
        ...
        List<GameClientSession> activeSessions)
    {
        ...
        foreach (var attack in attacks)
        {
            ...
            if (monsterId > 0)
            {
                ...
                matchRuntimes.GetOrThrow(matchingId).Progress.PendingMonsterHits.Add(new PendingSwarmMonsterHit(
