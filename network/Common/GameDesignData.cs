namespace network
{
    ...
    public static class GameDesignData
    {
        ...
        )
        {
            ...
            {
                conditions.Add(401000002, new() { (302000003, 1), (302000004, 1), (302000004, 6) }); // 허름한 좌판 (전도성 섬유 + 내화 섬유 + 방탄 섬유)
            }
            ...
            if (researches.Any(r => r.id == 1 && r.level >= 2))
            {
                conditions.Add(202000009, new() { (301000060, 1), (301000065, 1) }); // 탕후루 (과일 통조림 + 결정화 설탕)
