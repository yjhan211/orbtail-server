...
public static class GameDesignData
{
    public static (string, string, string, string, string) GetItemDetail(int item_id)
    {
        ...
        switch (item_id)
        {
            ...
            case 102000002:
                result = ("수습 화학자의 고글", "제한 없음", "정제 Lv1 사용 가능", "100", "화학 입문자의 든든한 파트너");
                break;
            ...
            case 201000001:
                ...
                break;
            case 202000007:
                result = ("참치 볶음", "조건 없음", "컨디션 5 회복", "", "참치가 이렇게 맛있을 줄이야.");
                break;
            case 202000008:
                result = ("수상한 라면", "조건 없음", "컨디션 5 회복", "", "뭔가 좀 이상하지만 맛있어요");
                break;
            case 202000009:
                result = ("탕후루", "조건 없음", "컨디션 10 회복", "", "달콤한 과일 한 입으로 힘을 내요.");
                break;
            case 202000010:
                result = ("밸런스 프로틴", "조건 없음", "컨디션 10 회복", "", "균형 잡힌 영양, 균형 잡힌 삶.");
                break;
            case 202000011:
                result = ("김치 참치 볶음밥", "조건 없음", "컨디션 10 회복", "", "한국인들의 소울 푸드.");
                break;
            case 202000012:
                result = ("소고기 라면", "조건 없음", "컨디션 10 회복", "", "라면에 소고기라니, 호화로운데?");
                break;
            case 202000013:
                result = ("프리 타임", "조건 없음", "컨디션 20 회복", "", "달콤함 속에 숨겨진 에너지의 비밀.");
                break;
            case 202000014:
                result = ("비타천", "조건 없음", "컨디션 20 회복", "", "하늘에서 내린 비타민의 축복.");
                break;
            case 202000015:
                result = ("연구원 정식", "조건 없음", "컨디션 30 회복", "", "연구원들의 머리를 맑게 해주는 특별 식단.");
                break;
            case 202000016:
                result = ("굿 밸런스 프로틴", "조건 없음", "컨디션 30 회복", "", "좋은 균형이 좋은 결과를 만듭니다.");
                break;
            case 202000017:
                result = ("나이트 워커 밀", "조건 없음", "컨디션 40 회복", "", "밤샘 연구의 강력한 동반자.");
                break;
            case 202000018:
                result = ("쿨파이브", "조건 없음", "컨디션 40 회복", "", "다섯 가지 맛으로 즐기는 쿨한 에너지");
                break;
            case 301000001:
            ...
            case 301000064:
                ...
                break;
            case 301000065:
                result = ("결정제 설탕", "제작 재료", "", "", "순수 설탕의 결정체.");
                break;
            case 301000066:
            ...
            case 401000001:
                ...
                break;
            case 401000002:
                result = ("허름한 좌판", "텐트", "아이템 3개 판매 가능", "", "물건을 판매하는 간소한 좌판");
                break;
        }
        ...
        {
            {
                ...
                (
                    ...
                    1,
                    "분해 Lv1 스킬이 필요해요.",
                    new List<int> { 301000001, 301000003, 301000003 }
                )
            },
            {
                10002,
                (
                    ...
                    1,
                    "분해 Lv1 스킬이 필요해요.",
                    new List<int> { 301000004, 301000006, 301000008 }
                )
            },
            {
                10003,
                (
                    ...
                    1,
                    "분해 Lv1 스킬이 필요해요.",
                    new List<int> { 301000007, 301000008, 301000006 }
                )
            },
            {
                10004,
            ...
            },
            {
                ...
                (
                    ...
                    1,
                    "분해 Lv1 스킬이 필요해요.",
                    new List<int> { 301000027, 301000023, 301000024 }
                )
            },
            {
                10009,
            ...
            },
            {
                ...
                (
                    ...
                    2,
                    "분해 Lv2 스킬이 필요해요.",
                    new List<int> { 301000002, 301000006, 301000053 }
                )
            },
            {
                10020,
                (
                    ...
                    2,
                    "분해 Lv2 스킬이 필요해요.",
                    new List<int> { 301000013, 301000049, 301000051 }
                )
            },
            {
                10021,
                (
                    ...
                    2,
                    "분해 Lv2 스킬이 필요해요.",
                    new List<int> { 301000016, 301000017, 301000002 }
                )
            },
            {
                10022,
                (
                    ...
                    2,
                    "분해 Lv2 스킬이 필요해요.",
                    new List<int> { 301000001, 301000006, 301000017 }
                )
            },
            {
                10023,
                (
                    ...
                    2,
                    "분해 Lv2 스킬이 필요해요.",
                    new List<int> { 301000013, 301000020, 301000021 }
                )
            },
            {
                10024,
                (
                    ...
                    2,
                    "분해 Lv2 스킬이 필요해요.",
                    new List<int> { 301000034, 301000053, 301000002 }
                )
            },
            {
                10025,
                (
                    ...
                    2,
                    "분해 Lv2 스킬이 필요해요.",
                    new List<int> { 301000006, 301000001, 301000033 }
                )
            },
            {
                10026,
                (
                    ...
                    2,
                    "분해 Lv2 스킬이 필요해요.",
                    new List<int> { 301000002, 301000017, 301000038 }
                )
            },
            {
                10027,
                (
                    ...
                    2,
                    "분해 Lv2 스킬이 필요해요.",
                    new List<int> { 301000001, 301000045, 301000024 }
                )
            },
            {
                10028,
                (
                    ...
                    3,
                    "분해 Lv3 스킬이 필요해요.",
                    new List<int> { 301000016, 301000046, 301000036 }
                )
            },
            {
                10029,
                (
                    ...
                    3,
                    "분해 Lv3 스킬이 필요해요.",
                    new List<int> { 301000007, 301000020, 301000013 }
                )
            },
            {
                10030,
                (
                    ...
                    3,
                    "분해 Lv3 스킬이 필요해요.",
                    new List<int> { 301000001, 301000038, 301000037 }
                )
            },
            {
                10031,
                (
                    ...
                    3,
                    "분해 Lv3 스킬이 필요해요.",
                    new List<int> { 301000016, 301000002, 301000036 }
                )
            },
            {
                10032,
                (
                    ...
                    3,
                    "분해 Lv3 스킬이 필요해요.",
                    new List<int> { 301000002, 301000053, 301000038 }
                )
            },
            {
                10033,
                (
                    ...
                    3,
                    "분해 Lv3 스킬이 필요해요.",
                    new List<int> { 301000001, 301000037, 301000006 }
                )
            },
            {
                10034,
                (
                    ...
                    3,
                    "분해 Lv3 스킬이 필요해요.",
                    new List<int> { 301000001, 301000098, 301000045 }
                )
            },
            {
                10035,
                (
                    ...
                    3,
                    "분해 Lv3 스킬이 필요해요.",
                    new List<int> { 301000001, 301000036, 301000096 }
                )
            },
            {
                10036,
                (
                    ...
                    3,
                    "분해 Lv3 스킬이 필요해요.",
                    new List<int> { 301000016, 301000034, 301000036 }
                )
            },
            {
                20019,
                (
                    ...
                    2,
                    "정제 Lv2 스킬이 필요해요.",
                    new List<int> { 301000055, 301000086, 301000100 }
                )
            },
            {
                20020,
                (
                    ...
                    2,
                    "정제 Lv2 스킬이 필요해요.",
                    new List<int> { 301000062, 301000072, 301000073 }
                )
            },
            {
                20021,
                (
                    ...
                    2,
                    "정제 Lv2 스킬이 필요해요.",
                    new List<int> { 301000100, 301000087, 301000098 }
                )
            },
            {
                20022,
                (
                    ...
                    2,
                    "정제 Lv2 스킬이 필요해요.",
                    new List<int> { 301000085, 301000086, 301000089 }
                )
            },
            {
                20023,
                (
                    ...
                    2,
                    "정제 Lv2 스킬이 필요해요.",
                    new List<int> { 301000072, 301000086, 301000087 }
                )
            },
            {
                20024,
                (
                    ...
                    2,
                    "정제 Lv2 스킬이 필요해요.",
                    new List<int> { 301000100, 301000101, 301000062 }
                )
            },
            {
                20025,
                (
                    ...
                    2,
                    "정제 Lv2 스킬이 필요해요.",
                    new List<int> { 301000086, 301000085, 301000064 }
                )
            },
            {
                20026,
                (
                    ...
                    2,
                    "정제 Lv2 스킬이 필요해요.",
                    new List<int> { 301000079, 301000080, 301000082 }
                )
            },
            {
                20027,
                (
                    ...
                    2,
                    "정제 Lv2 스킬이 필요해요.",
                    new List<int> { 301000096, 301000098, 301000099 }
                )
            },
            {
                20028,
                (
                    ...
                    3,
                    "정제 Lv3 스킬이 필요해요.",
                    new List<int> { 301000097, 301000098, 301000100 }
                )
            },
            {
                20029,
                (
                    ...
                    3,
                    "정제 Lv3 스킬이 필요해요.",
                    new List<int> { 301000085, 301000086, 301000064 }
                )
            },
            {
                20030,
                (
                    ...
                    3,
                    "정제 Lv3 스킬이 필요해요.",
                    new List<int> { 301000096, 301000094, 301000092 }
                )
            },
            {
                20031,
                (
                    ...
                    3,
                    "정제 Lv3 스킬이 필요해요.",
                    new List<int> { 301000062, 301000098, 301000100 }
                )
            },
            {
                20032,
                (
                    ...
                    3,
                    "정제 Lv3 스킬이 필요해요.",
                    new List<int> { 301000086, 301000087, 301000097 }
                )
            },
            {
                20033,
                (
                    ...
                    3,
                    "정제 Lv3 스킬이 필요해요.",
                    new List<int> { 301000055, 301000072, 301000097 }
                )
            },
            {
                20034,
                (
                    ...
                    3,
                    "정제 Lv3 스킬이 필요해요.",
                    new List<int> { 301000087, 301000086, 301000080 }
                )
            },
            {
                20035,
                (
                    ...
                    3,
                    "정제 Lv3 스킬이 필요해요.",
                    new List<int> { 301000072, 301000086, 301000100 }
                )
            },
            {
                20036,
                (
                    ...
                    3,
                    "정제 Lv3 스킬이 필요해요.",
                    new List<int> { 301000098, 301000099, 301000096 }
                )
            }
        };

        if (jobResources.TryGetValue(job_resource_id, out var result)) return result;
    ...
    {
        var item_type = item_id / 1000000;
        var label_number = item_id % 1000000;
    ...
    {
        var target_job_type = JobType.NONE;
        var target_job_grade = JobGrade.NONE;
        ...
        if (target_job_type == JobType.NONE) return job_stat_dict.Any(kvp => kvp.Value.JobGrade >= target_job_grade);

        if (!job_stat_dict.TryGetValue(target_job_type, out var job_stat)) return false;
    ...
    public static List<ResearchInfo> GetRequireResearch(int research_id)
    {
        ...
        switch (research_id)
        {
            ...
            case 2: // 식량 제작
                result.Add(new ResearchInfo(1, 1)); // 재료 공학 1레벨
                result.Add(new ResearchInfo(3, 1)); // 분석 화학 1레벨
                break;
            ...
            case 4: // 소재 공학
                result.Add(new ResearchInfo(1, 2)); // 재료 공학 2레벨
                break;

            case 5: // 장비 제작
                result.Add(new ResearchInfo(4, 1)); // 소재 공학 1레벨
                result.Add(new ResearchInfo(6, 1)); // 유기 화학 1레벨
                break;

            case 6: // 유기 화학
                result.Add(new ResearchInfo(3, 2)); // 분석 화학 2레벨
                break;

            case 7: // 제어 공학
                result.Add(new ResearchInfo(1, 5)); // 재료 공학 5레벨
                result.Add(new ResearchInfo(4, 5)); // 소재 공학 5레벨
                break;

            case 8: // 에너지 제작
                result.Add(new ResearchInfo(7, 1)); // 제어 공학 1레벨
                result.Add(new ResearchInfo(9, 1)); // 무기 화학 1레벨
                break;

            case 9: // 무기 화학
                result.Add(new ResearchInfo(3, 5)); // 분석 화학 5레벨
                result.Add(new ResearchInfo(6, 5)); // 유기 화학 5레벨
                break;

            case 10: // 전자 공학
                result.Add(new ResearchInfo(1, 8)); // 재료 공학 8레벨
                result.Add(new ResearchInfo(4, 8)); // 소재 공학 8레벨
                result.Add(new ResearchInfo(7, 8)); // 제어 공학 8레벨
                break;

            case 11: // 의약품 제작
                result.Add(new ResearchInfo(10, 1)); // 전자 공학 1레벨
                result.Add(new ResearchInfo(12, 1)); // 생화학 1레벨
                break;

            case 12: // 생화학
                result.Add(new ResearchInfo(3, 8)); // 분석 화학 8레벨
                result.Add(new ResearchInfo(6, 8)); // 유기 화학 8레벨
                result.Add(new ResearchInfo(9, 8)); // 무기 화학 8레벨
                break;
        }
    ...
    )
    {
        ...
        {
            conditions.Add(302000001,
                new List<(int id, int count)> { (301000001, 1), (301000008, 1) }); // 강화 플라스틱 (플라스틱 케이스 + 나사)
            conditions.Add(302000002,
                new List<(int id, int count)> { (301000003, 1), (301000013, 1) }); // 유연성 강화 키트 (고무 키캡 + 스프링)
        }

        if (researches.Any(r => r.id == 1 && r.level >= 2))
        {
            conditions.Add(302000003,
                new List<(int id, int count)> { (301000006, 1), (301000014, 1) }); // 전도성 섬유 (구리 와이어 + 고무 그립)
            conditions.Add(302000004,
                new List<(int id, int count)> { (301000027, 1), (301000024, 1) }); // 내화 섬유 (합판 조각 + 니스 조각)
        }

        // 식량 제작 (ID: 2)
        if (researches.Any(r => r.id == 2 && r.level >= 1))
        {
            conditions.Add(202000015,
                new List<(int id, int count)> { (202000011, 1), (202000012, 1) }); // 연구원 정식 (김치 참치 볶음밥 + 소고기 라면)
            conditions.Add(202000016,
                new List<(int id, int count)> { (202000013, 1), (202000014, 1) }); // 굿 밸런스 프로틴 (프리 타임 + 비타천)
        }

        if (researches.Any(r => r.id == 2 && r.level >= 2))
        {
            conditions.Add(202000017,
                new List<(int id, int count)>
                    { (202000015, 1), (202000016, 1), (301000055, 1) }); // 나이트 워커 밀 (연구원 정식 + 굿 밸런스 프로틴 + 카페인 추출물)
            conditions.Add(202000018,
                new List<(int id, int count)>
                    { (202000014, 1), (301000056, 1), (301000060, 1) }); // 쿨파이브 (비타천 + 타우린 파우더 + 과일 통조림)
        }

        // 분석 화학 (ID: 3)
        if (researches.Any(r => r.id == 3 && r.level >= 1))
        {
            conditions.Add(202000007,
                new List<(int id, int count)> { (301000058, 1), (301000063, 1) }); // 참치 볶음 (참치 통조림 + 조미료 팩)
            conditions.Add(202000008,
                new List<(int id, int count)> { (301000061, 1), (301000062, 1) }); // 수상한 라면 (인스턴스 면 + 건조 야채)
        }

        if (researches.Any(r => r.id == 3 && r.level >= 2))
        {
            conditions.Add(202000009,
                new List<(int id, int count)> { (301000060, 1), (301000065, 1) }); // 탕후루 (과일 통조림 + 결정제 설탕)
            conditions.Add(202000010,
                new List<(int id, int count)> { (301000067, 1), (301000068, 1) }); // 밸런스 프로틴 (압축 단백질 + 견과류 조각)
        }

        // 소재 공학 (ID: 4)
        if (researches.Any(r => r.id == 4 && r.level >= 1))
        {
            conditions.Add(302000005,
                new List<(int id, int count)> { (302000001, 1), (302000003, 1) }); // 충격 흡수 패드 (강화 플라스틱 + 전도성 섬유)
            conditions.Add(302000006,
                new List<(int id, int count)> { (302000002, 1), (302000004, 1) }); // 방탄 섬유 (유연성 강화 키트 + 내화 섬유)
        }

        if (researches.Any(r => r.id == 4 && r.level >= 2))
            conditions.Add(401000002,
                new List<(int id, int count)>
                    { (302000003, 1), (302000004, 1), (302000006, 1) }); // 허름한 좌판 (전도성 섬유 + 내화 섬유 + 방탄 섬유)

        // 장비 제작 (ID: 5)
        if (researches.Any(r => r.id == 5 && r.level >= 1))
        {
            conditions.Add(102000003,
                new List<(int id, int count)> { (102000001, 1), (302000005, 1) }); // 정식 공학자의 헬멧 (수습 공학자의 헬멧 + 충격 흡수 패드)
            conditions.Add(102000004,
                new List<(int id, int count)> { (102000002, 1), (302000005, 1) }); // 정식 화학자의 고글 (수습 화학자의 고글 + 충격 흡수 패드)
            conditions.Add(103000002,
                new List<(int id, int count)> { (103000001, 1), (302000006, 1) }); // 정식 연구원의 제복 (수습 연구원의 제복 + 방탄 섬유)
        }

        if (researches.Any(r => r.id == 5 && r.level >= 2))
        {
            conditions.Add(102000006,
                new List<(int id, int count)>
                    { (102000003, 1), (302000005, 1), (302000006, 1) }); // 오토바이 헬멧 (정식 공학자의 헬멧 + 충격 흡수 패드 + 방탄 섬유)
            conditions.Add(102000007,
                new List<(int id, int count)>
                    { (102000004, 1), (302000005, 1), (302000006, 1) }); // 오토바이 고글 (정식 공학자의 고글 + 충격 흡수 패드 + 방탄 섬유)
            conditions.Add(103000004,
                new List<(int id, int count)>
                    { (103000002, 1), (302000005, 1), (302000006, 1) }); // 습지 탐사 우비 (정식 연구원의 제복 + 충격 흡수 패드 + 방탄 섬유)
            conditions.Add(104000004,
                new List<(int id, int count)>
                    { (104000001, 1), (302000005, 1), (302000006, 1) }); // 습지 탐사 장화 (연구원의 구두 + 충격 흡수 패드 + 방탄 섬유)
        }

        // 유기 화학 (ID: 6)
        if (researches.Any(r => r.id == 6 && r.level >= 1))
        {
            conditions.Add(202000011,
                new List<(int id, int count)> { (202000007, 1), (301000072, 1) }); // 김치 참치 볶음밥 (참치 볶음 + 김치)
            conditions.Add(202000012,
                new List<(int id, int count)> { (202000008, 1), (301000077, 1) }); // 소고기 라면 (수상한 라면 + 소고기 육포)
        }

        if (researches.Any(r => r.id == 6 && r.level >= 2))
        {
            conditions.Add(202000013,
                new List<(int id, int count)>
                    { (202000009, 1), (301000070, 1), (301000071, 1) }); // 프리 타임 (탕후루 + 초콜릿 조각 + 카카오 버터)
            conditions.Add(202000014,
                new List<(int id, int count)>
                    { (202000010, 1), (301000069, 1), (301000057, 1) }); // 비타천 (밸런스 프로틴 + 건조 과일 조각 + 비타민 복합체)
        }

        foreach (var (key, conditionList) in conditions)
        {
            if (make_materials.Count != conditionList.Count) continue;
