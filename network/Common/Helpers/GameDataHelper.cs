...
public static class GameDataHelper
{
    ...
    private static readonly (string fileName, Action<Dictionary<string, CsvRow>> init, Action<LogManager> validate)[]
        ...
        [
            (DataFiles.GameRule, GameRuleData.Initialize, GameRuleData.Validate),
            (DataFiles.BuffInfo, GameBuffData.Initialize, GameBuffData.Validate)
        ];

    [MemberNotNull(nameof(_logManager))]
    ...
    private static class DataFiles
    {
        ...
        public static class Item
        {
            ...
            public static readonly string[] ALL = [Base, Equipment, Consumable, Installation, Shop];
        }
    }
}