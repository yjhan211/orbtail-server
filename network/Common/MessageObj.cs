...
namespace network.common
{
    ...
    {
        [Key("accountToken")]
        public string AccountToken { get; set; } // (임시) 현재 아무 의미 없음 .. 추후 계정키로 변경 예정
    }
    ...
    {
        [Key("objectList")]
        public List<GameObjectInfo> ObjectList { get; set; }
    ...
    {
        [Key("playerIdList")]
        public List<long> PlayerIdList { get; set; }
    }
    ...
    {
        [Key("objectInfoList")]
        public List<GameObjectInfo> ObjectInfoList { get; set; }
    }

    [MessagePackObject]
    public class C_TO_U_EXPLORE_TARGET_INFO : IMessagePackObject
    {
        [Key("exploreTargetIdList")]
        public List<long> ExploreTargetIdList { get; set; }
    }
    ...
    public class U_TO_C_EXPLORE_TARGET_INFO : IMessagePackObject
    {
        ...
        public List<ExploreTargetInfo> ExploreTargetList { get; set; }
    }

    [MessagePackObject]
    public class G_TO_U_EXPLORE_TARGET_INFO : IMessagePackObject
    {
        [Key("exploreTargetInfo")]
        public ExploreTargetInfo ExploreTargetInfo { get; set; }
    }

    [MessagePackObject]
    public class C_TO_U_JOB_RESOURCE_INFO : IMessagePackObject
    {
        [Key("jobResourceIdList")]
        public List<long> JobResourceIdList { get; set; }
    }

    [MessagePackObject]
    public class U_TO_C_JOB_RESOURCE_INFO : IMessagePackObject
    {
        [Key("jobResourceInfoList")]
        public List<JobResourceInfo> JobResourceInfoList { get; set; }
    }
    ...
    {
        [Key("hireList")]
        public List<(long, string, string)> HireList { get; set; }
    }
    ...
    {
        [Key("joinPlayerInfo")]
        public PlayerInfo JoinPlayerInfo { get; set; }
    ...
    {
        [Key("campInfoList")]
        public List<CampInfo> CampInfoList { get; set; }
    }
    ...
    {
        [Key("campInfoList")]
        public List<long> CampInfoList { get; set; }
    }
    ...
    public class C_TO_U_BUY_ITEM : IMessagePackObject
    {
        ...
        [Key("sellItemUid")]
        public long SellItemUid { get; set; }
    }
