...
internal static class TestGameSessionServices
{
    ...
    public static PlayerOrbState Orbs(MatchRuntime match, long playerId) => GetOrRegisterPlayer(match, playerId).Orbs;
        ...
        Microsoft.Extensions.Logging.ILogger logger)
    {
        ...
        return new PlayerEliminationService(results, new MatchSynchronizationService(), logger);
    }
