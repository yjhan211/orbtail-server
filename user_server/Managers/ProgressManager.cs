...
namespace user_server.managers
{
    ...
    {
        public IProgressTrackable Trackable { get; }
        public Func<IProgressTrackable, Task> OnComplete { get; }

        public ProgressItem(IProgressTrackable trackable, Func<IProgressTrackable, Task> onComplete)
        {
            Trackable = trackable;
    ...
    public class ExploreProgressInfo(ExploreTargetInfo exploreTargetInfo) : IProgressTrackable
    {
        ...
        public DateTime GetEndTime() => ExploreTargetInfo.EndTimestamp;
    }
    ...
    public class JobProgressInfo(JobResourceInfo jobResourceInfo) : IProgressTrackable
    {
        ...
        public DateTime GetEndTime() => JobResourceInfo.EndTimestamp;
    }
